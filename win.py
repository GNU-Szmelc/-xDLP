...
class YTDLPInterface(QWidget):
    ...
    def initUI(self):
        self.setWindowTitle('[$xDLP] [WIN] ~ Less Shitty YT Client')
    ...
    def run_ytdlp_command(self, args):
        ...
        subprocess.call(args, shell=True)  # Use shell=True on Windows
    ...
    def perform_youtube_search(self, search_query):
        API_KEY = "AIzaSyCSVVoqQohX0L7BUIfyitjF9GrOgpA1MTE"  # Replace with your YouTube API key
        MAX_RESULTS = 10
